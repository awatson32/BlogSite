...
/**
  ...
  */
export declare class Button extends plat.ui.BindControl implements IUiControl {
...
/**
  ...
  */
export declare class ProgressRing extends plat.ui.TemplateControl implements IUiControl {
    /**
      * The HTML template represented as a string.
      */
    templateString: string;
...
/**
  ...
  */
export declare class ProgressBar extends plat.ui.TemplateControl implements IUiControl {
    protected static _inject: any;
    /**
      * The HTML template represented as a string.
      */
...
/**
  ...
  */
export declare class Drawer extends plat.ui.BindControl implements IUiControl {
    protected static _inject: any;
    /**
      * The evaluated plat-options object.
      */
    ...
    /**
      ...
      * @param {DrawerController} controller The DrawerController
      * to splice.
      */
...
/**
  ...
  */
export declare class DrawerController extends plat.ui.BindControl implements IUiControl {
    protected static _inject: any;
    /**
      * The evaluated plat-options object.
      */
...
/**
  ...
  */
export declare class Slider extends plat.ui.BindControl implements IUiControl {
    protected static _inject: any;
    /**
      * The HTML template represented as a string.
      */
    ...
    /**
      ...
      * @param {number} value The current value of the {link Slider|Slider}.
      */
    ...
    /**
      * Sets the increment for sliding the {link Slider|Slider}.
      */
...
/**
  ...
  */
export declare class Range extends plat.ui.BindControl implements IUiControl {
    protected static _inject: any;
    /**
      * The HTML template represented as a string.
      */
    ...
    /**
      * Calculates knob position based on current value.
      * @param {number} value The current value of the {link Range|Range}.
      */
    protected _calculateKnobPosition(value: number): number;
    /**
    ...
    /**
      * Sets the increment for sliding the {link Range|Range}.
      */
    protected _setIncrement(): number;
    /**
...
/**
  ...
  */
export declare class Select extends plat.ui.controls.Select implements IUiControl {
    /**
      * Sets the classes on the proper elements.
      * @param {string} className? An optional, additional class name or class names to set on the control
      * in addition to its standard set.
...
/**
  ...
  */
export declare class File extends plat.ui.BindControl implements IUiControl, IFormControl {
    protected static _inject: any;
    /**
      * The HTML template represented as a string.
      */
...
/**
  ...
  */
export declare class Carousel extends plat.ui.controls.ForEach implements plat.observable.ISupportTwoWayBinding, IUiControl {
    protected static _inject: any;
    /**
      * The HTML template represented as a string.
      */
...
/**
  ...
  */
export declare class Listview extends plat.ui.TemplateControl implements IUiControl {
    protected static _inject: any;
    /**
      * The HTML template represented as a string.
      */
    ...
    /**
      ...
      * @param {IGroupHash} group? The group we're rendering.
      */
    ...
    /**
      ...
      * @param {IGroupHash} group? The group we're rerendering.
      */
    ...
    /**
      ...
      * @param {IGroupHash} group The group for which we're creating items.
    ...
    /**
      ...
      * @param {IGroupHash} group The group that we're performing this operation on.
      * @param {number} animateItems The number of items to animate.
      */
    ...
    /**
      ...
      * @param {IGroupHash} group The group items are being added to.
      */
    ...
    /**
      ...
      * @param {number} index The index to start disposing from.
      * @param {number} numberOfItems The number of items to remove.
      * @param {IGroupHash} group The group for which we're disposing items.
      */
    ...
    /**
      ...
      * @param {IGroupHash} The object representing the current group.
      */
...
/**
  ...
  */
export declare class Navbar extends plat.ui.TemplateControl implements IUiControl {
    protected static _inject: any;
    /**
      * The HTML template represented as a string.
      */
    ...
    /**
      ...
      * @param {INavbarComponent} component The component to be set as the sole item in
      * the left part of the Navbar.
      */
    setLeft(component: INavbarComponent): void;
    /**
      * Sets the left part of the Navbar.
      * @param {Array<INavbarComponent>} components An Array of components to be set as the left
      * Navbar's items.
      */
    ...
    /**
      * Sets the center part of the Navbar.
      * @param {Array<INavbarComponent>} components An Array of components to be set as the center
      * Navbar's items.
      */
    ...
    /**
      ...
      * @param {Array<INavbarComponent>} components An Array of components to be set as the right
      * Navbar's items.
      */
    ...
    /**
      ...
      * @param {INavbarComponent} component The INavbarComponent
    ...
    /**
      ...
      * to the determined INavbarComponent(s).
      * @param {string} position The part of the Navbar being set.
      * @param {Array<INavbarComponent>} components The INavbarComponents
      * to set as the context.
      */
    ...
    /**
      ...
      * @param {INavbarComponent} newComponent The new INavbarComponent
      * to parse.
      * @param {INavbarComponent} oldComponent? The old INavbarComponent
...
/**
  ...
  */
export declare class Image extends plat.ui.TemplateControl implements IUiControl {
    protected static _inject: any;
    /**
      * The HTML template represented as a string.
      */
